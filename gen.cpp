...
void generate_test() {
  int n = rand(1, 1000), k = rand(-100000, 100000);
  if(test >= 15) n = (int)1e6;

  ofstream myfile;
  myfile.open ("input" + to_string(test) + ".txt");
	myfile << n << " " << k << '\n';
	myfile << gen_array(n, -500000, 500000);
  myfile.close();
}
