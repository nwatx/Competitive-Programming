...
void solve() {
	int n; re(n);
    vi v(n); re(v);
    // there cannot be a sequence of 5 numbers where it is strictly increasing / decreasing
    V<char> ret;
    ...
    while (l <= r) {
        ...
        if (inc) {
            if (a < lst) {
                ...
                // cannot find something to break increasing than choose the higher of a and b
                if (a > b) {
                    ++l;
                    lst = a;
                    ret.pb('L');
