...
// 1 10 2 3 3
// -1 -1 -1 -1
// assume med a[l:r] = x; bad if even and we can "push" x out of the middle range => bad if even and sum(b[l, r]) == 0
// x must also exist (to avoid overcounting)
