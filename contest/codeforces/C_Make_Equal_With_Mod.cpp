...
// observation: odd numbers can turned even via using n - 1
// the only case where it's not true if both 1 and 0 are in the set
// or if n = 1 and all the numbers <= 2

void solve() {
	int n; re(n);
	vi v(n); re(v);
	// everything >= 2 can be reduced to zero
	// everything >= 3 can be reduced to one
