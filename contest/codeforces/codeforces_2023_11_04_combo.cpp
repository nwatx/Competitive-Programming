...
// (0, 1)
// (0, 1, 2, 1, 0), (0, 1, 2, 1, 2), (0, -1, 0, 1, 2), (0, 1, 0, 1, 2)

// (0, 1, 2, 3, 2, 3, 2), (0,  1, 2, 3, 2, 1, 2), (0, 1, 2, 3, 2, 1, 0)
// (0, 1, 2, 1, 2, 3, 2), (0, -1, 0, 1, 2, 3, 2), (0, 1, 0, 1, 2, 3, 2)
inline mi f(int t, int m) {
	int mt = m + t;
	if(mt & 1) return mi(0);
	int up = mt / 2;
	return scmb[t][up];
