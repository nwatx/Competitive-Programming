...
// [token placed in each integer point in [1, n]]
// Remove a token in the closed segment [a_i, i] that has not been removed; otherwise do nothing
// f(a) is the number of ways to remove tokens
