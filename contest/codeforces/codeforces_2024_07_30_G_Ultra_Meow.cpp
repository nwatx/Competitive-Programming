...
/* Scratch Work
a = {1}, {0} => MEX({1}, 2) = 3, MEX({0}, 1) = 1

test: 0, 1, 2
answer: subsets of size 2 = {1, 2} = 5 size 1 = {1} = 3, {2} = 3 and size 0 = 1

test: 0, 1, 2, 3
answer: 12 + additional subsets of size 2 + additional subsets of size 1
- 
*/
