...
// base 3 encode a board
// state: 0, 1, 2
int set(int x, int bit, int state) {
	int rm = x % pow3[bit + 1] / pow3[bit];
	return x - rm * pow3[bit] + rm * state;
}
